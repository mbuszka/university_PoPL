  ...
  (define value-of/k
    (lambda (exp env cont)
      (cases expression exp
        ...
        (list-exp (lst)
            (value-of-list lst env cont))
   )))

  (define (value-of-list lst env cont)
    (if (null? lst)
        (apply-cont cont (list-val lst))
        (value-of/k (car lst) env (tail-cont (cdr lst) env cont))))
  ...
  (define apply-cont
    (lambda (cont val)
      (cases continuation cont
        ...
        (tail-cont (lst env saved-cont)
          (value-of-list lst env (cons-cont val saved-cont)))
        (cons-cont (v saved-cont)
          (apply-cont saved-cont (list-val (cons v (expval->list val)))))
